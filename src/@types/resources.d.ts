...
interface Resources {
  "common": {
    ...
    "projectMenu": {
      ...
      "importProjectNamePlaceholder": "Enter a name for the new project",
      "importToCurrent": "Replace current project",
      "importToCurrentDescription": "The imported data will replace your current project and sync to the cloud.",
      "importToNew": "Create new project",
      "importToNewDescription": "A new project will be created with the imported data.",
      "initialSyncError": "Failed to sync project",
  ...
  "tool": {
    ...
    "intermediateWall": {
      ...
      "controlEnter": "{{key}} to complete wall",
      "controlEscAbort": "{{key}} to abort wall",
    ...
    "splitWall": {
      ...
      "info": "Split walls to create segments with different wall assemblies.",
  ...
  "toolbar": {
    ...
    "tools": {
      ...
      "perimeterPreset": "Perimeter Presets",
  ...
  "viewer": {
    ...
    "tagOpacity": {
      "fullCategory": "Visible Category",
      "hideCategory": "Hidden Category",
      "noTags": "No tags available",
      "semiCategory": "Semi-transparent Category",
      "title": "Tag Visibility"
    }
  },
  "welcome": {
