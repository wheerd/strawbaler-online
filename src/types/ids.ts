...
export type CornerId = string & { readonly brand: unique symbol }
...
export const createCornerId = (): CornerId => `corner_${Date.now()}_${Math.random()}` as CornerId
...
export const isCornerId = (id: string): id is CornerId => id.startsWith('corner_')
