...
import { bitumen, brick, cork, roughWood, woodwool } from '@/materials/defaults'
...
export function RingBeamAssemblyContent(props?: RingBeamAssemblyContentProps): React.JSX.Element {
