...
import { getShapeGeometry } from '@/viewer3d/utils/geometryCache'
import { getLineMaterial, getMeshMaterial } from '@/viewer3d/utils/materialCache'
...
function ConstructionElement3D({ element, parentOpacity = 1 }: ConstructionElement3DProps): React.JSX.Element | null {
  ...
  return (
    <group position={position} rotation={rotation} scale={scale}>
      <mesh geometry={geometry} userData={{ geometryKey: cacheKey, opacity }} dispose={null} material={meshMaterial}>
