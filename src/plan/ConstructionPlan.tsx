...
import { bounds3Dto2D, createProjectionMatrix, projectPoint } from '@/construction/assemblies/utils/geometry'
import { type ProjectedOutline, projectManifoldToView } from '@/construction/manifold/transform'
import type { GroupOrElement } from '@/construction/model/elements'
import type { ConstructionModel, HighlightedPolygon } from '@/construction/model/model'
import type { ConstructionIssue } from '@/construction/model/results'
import type { TagOrCategory } from '@/construction/model/tags'
import { CutAreaShape } from '@/plan/CutAreaShape'
import { Measurements } from '@/plan/Measurements'
import { sanitizeForCssClass } from '@/plan/cssHelpers'
import { type FaceTree, geometryFaces } from '@/plan/faceHelpers'
import { accumulateIssueWorldManifolds } from '@/plan/issueHelpers'
import {
  Bounds2D,
  IDENTITY,
  type Plane3D,
